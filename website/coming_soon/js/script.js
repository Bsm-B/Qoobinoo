...
var preloader_color_text = "#ff0066"; // Preloader text color
var liquid_color = "#ffcc00"; // Color of animated liquid
...
var logo_url = "https://www.qoobinoo.io"; // Specify URL when clicking on logo
...
function counter_start() {
	...
	austDay = new Date(austDay.getFullYear(), 6 - 1, 6); // Examples: (austDay.getFullYear() + 1, 3 - 1, 6) or (2013, 3 - 1, 6)
